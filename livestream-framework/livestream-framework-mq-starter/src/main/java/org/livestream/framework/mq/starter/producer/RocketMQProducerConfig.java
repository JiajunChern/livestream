package org.livestream.framework.mq.starter.producer;

import jakarta.annotation.Resource;
import org.apache.rocketmq.client.exception.MQClientException;
import org.apache.rocketmq.client.producer.DefaultMQProducer;
import org.apache.rocketmq.client.producer.MQProducer;
import org.livestream.framework.mq.starter.properties.RocketMQProducerProperties;
...
public class RocketMQProducerConfig {
    ...
    public MQProducer mqProducer() {
        ...
        try {
            ...
            System.out.println("=============== mq 生产者启动成功, namesrv is " + rocketMQProducerProperties.getNameSrv() + " ==================");
